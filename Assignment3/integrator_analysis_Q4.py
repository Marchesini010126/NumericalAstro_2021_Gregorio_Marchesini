...
for current_phase in range( number_of_phases ):
    ...
    if run_question_4:
        current_phase_start_time = current_phase_start_time + get_closest_approach_time(current_phase_start_time,
                                                                current_phase_end_time,
                                                                current_central_body)
        tc = get_closest_approach_time(current_phase_start_time,
                                        current_phase_end_time,
                                        current_central_body)
        
    print('time of clsest approach')
    print('{}[s]'.format(tc))

    print(current_phase_start_time/60/60/24)
    ...
    benchmark_dynamics_simulator = numerical_simulation.SingleArcSimulator(bodies,
    ...
    for kk,current_tolerance in enumerate(integration_tolerances):
        ...
        print('Solving solution for tolerance --- > {}'.format(current_tolerance))
        ...
        file_output_identifier = "./exercise4/tolerance_" +\
