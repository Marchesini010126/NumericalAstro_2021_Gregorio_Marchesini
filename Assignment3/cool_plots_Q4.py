...
dir_name   = 'SimulationOutput/exercise4'
dir_name_2 = 'SimulationOutput/exercise2'

files_list    = os.listdir(dir_name)
files_list_2  = os.listdir(dir_name_2)
...
difference_type              = ["keplerian","benchmark"]
...
for file in files_list :
    ...
    elif "keplerian" in file_markers :
        for tol in integration_tolerances_names :
            if tol in file_markers:
                power_tol = tol.split('n')[1]
...
fig1.tight_layout()
fig1.suptitle('BENCHMARK DIFFERENCE')
fig1.subplots_adjust(top=0.88)

fig2.tight_layout()
fig2.suptitle('KEPLERIAN DIFFERENCE')
